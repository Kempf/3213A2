...
void movingAverage(uint16_t *sample, uint8_t *th_latch, uint16_t *count, uint16_t *pa /*This is an array. Go figure.*/, uint16_t *circles, uint16_t *triangles, uint16_t *horns, uint16_t *time, uint16_t *oneOver, uint16_t *time_start, uint16_t* time_end)
{
