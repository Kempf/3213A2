...
int main(void)
{
	...
	while(1)
    {
        ...
        {
            adc_process(&adc_data, &th_latch, &count, adc_array, &r, &s, &h, &n, &time_ms, &ts, &te, &f, &w, &td, &zero, &toggle, &int_total, &peak);
